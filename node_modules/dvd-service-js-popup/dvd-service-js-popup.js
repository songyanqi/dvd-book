...
export default {
  ...
  toast(html, duration){
    new Vue({
      components: {
        'com-popup-toast': require('dvd-service-com-popup-toast').default
      },
      el: getEl(),
      data: {html, duration},
  ...
  shareCard(img){
    new Vue({
      components: {
        'dvd-service-com-popup-share-card': require('dvd-service-com-popup-share-card').default
      },
      el: getEl(),
      data: {img},
  ...
  alert(param = {}){
    new Vue({
      components: {
        'com-popup-base': require('dvd-service-com-popup').default
      },
      el: getEl(),
      data: {param},
