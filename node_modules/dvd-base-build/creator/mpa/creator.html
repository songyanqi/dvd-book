...
<head>
  ...
  <link rel="stylesheet" href="[[static]]/page/{{name}}/css/{{name}}.css[[v]]">
</head>
<body>
  <div class="app" v-cloak
    ...
    <!--标题-->
    <dvd-service-com-title title="${{title}}" back home></dvd-service-com-title>
  ...
  <script src="[[static]]/page/{{name}}/js/{{name}}.js[[v]]"></script>
</body>
</html>
