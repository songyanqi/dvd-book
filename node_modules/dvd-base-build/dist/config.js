...
console.log('mini: ' + process.env.mini);
...
/************************* 文件glob路径 ***************************/
var path = {
  html: ['src/page/' + env.page + '/*.html', 'node_modules/dvd-base-build/html-inc/ssr_template.html'],
  css: ['src/*page/' + env.page + '/css/*.scss', 'src/*common/css/common.scss'],
  js: 'src/page/' + env.page + '/js/*.js',
  router: 'src/*page/' + env.page + '/js/router.js',
  dll: 'node_modules/dvd-base-build/dist/dll/*.dll' + (env.env && '.min') + '.js',
...
var config = {
  ...
  babel: babel,
  'dvd-service-js-native': _fs2.default.readFileSync(__dirname + '/../../dvd-service-js-native/package.json', 'utf-8')
};
