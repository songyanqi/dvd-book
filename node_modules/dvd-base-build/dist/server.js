...
function start(port) {
  ...
  router.get('/', function (req, res, next) {
    ...
    var renderer = createBundleRenderer(require('../../../dist/static/vue-ssr-server-bundle.json'), {
      runInNewContext: false, // 推荐
      // template: __dirname + '/dist/view/index.html', // （可选）页面模板
      template: require('fs').readFileSync('./dist/view/index.html', 'utf-8'), // （可选）页面模板
      clientManifest: require('../../../dist/static/vue-ssr-client-manifest.json') // （可选）客户端构建 manifest
      // inject: false
    });
