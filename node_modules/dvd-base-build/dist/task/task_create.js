...
_gulp2.default.task('task_create', function () {
  ...
  _inquirer2.default.prompt([{
    ...
    // 模板文件路径
    var tplFilePath = 'node_modules/dvd-base-build/creator/' + answer.type + '/**/*.*';

    // 生成文件路径
    var destFilePath = 'src/page/' + answer.name;

    // 开始生成文件
    _gulp2.default.src(tplFilePath)
    // 统一文件名称
    ...
    .on('end', function () {
      setTimeout(function () {
        _fs2.default.mkdirSync(destFilePath + '/img');
        _fs2.default.mkdirSync(destFilePath + '/vue');
      }, 1000);
    });
