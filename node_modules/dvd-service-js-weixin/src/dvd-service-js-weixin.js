...
const config = {
    ...
    defaultShareInfo: {
        title: 'MAMA+|大V店', // 分享标题
        desc: 'MAMA+|大V店', // 分享描述
        link: runtime.isClient() && window.location.href, // 分享链接
...
export default {
    ...
    setShareInfo(param, response) {
        ...
        } else if (runtime.isClient() && window && window.shareSource) {
        ...
        function shareInfoPost(msg) {
            ...
            if (shareSource) {
                ...
                if (runtime.isClient() && window.gio) {
     ...
     */
    goAuthPage(show, tag, parameter, isAutoLogin) {
        if (login.isLogined()) {
            return;
        }
